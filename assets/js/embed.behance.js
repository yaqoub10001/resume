...
$.fn.embedBehance = function( options ) {
	...
	var settings = $.extend({
		...
		projectUrl: true,
		fields: true,
		apiKey: '9MJpdxC11jMmnch2TZLa7pMR8wZ26RpQ',
		itemsPerPage: '9',
		userName: 'yaqoub10001',
 ...
 $('body').append('<div class="eb-loadingicon">' + iconsSet('loading') + '</div>');
	...
	function designTemplate(token, value) {
      ...
      dataWrapper += '<div class="wrap-cover">';
        ...
        if(settings.fields == true) {
          ...
          dataWrapper += '<li class="single ft-28">' + value.name  + '</li>';
	...
	function printContentForList() {
		...
		$.each(dataExtracted, function(key, value){
			...
			html += value['rawId'];
      html += value['cover'];
      html += '<div class="px-3 pt-3 pb-4">'+ value['title'] + value['owners'] + value['appreciations'] + value['views'] + '</div>';
      //<div class="px-4 pt-2 pb-4"> use this div start if your adding views and other info in projects
